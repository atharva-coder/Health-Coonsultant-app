...
function setup(){
  ...
  neckpain = createSprite(windowWidth/7,windowHeight/3);
  ...
  hospital2  = createSprite(windowWidth/5+300,windowHeight/3+300);
...
function pg2(){
  ...
  text("which Problem are You Facing From?",windowWidth/5,windowHeight/6);
   ...
   textSize(30);
   fill("yellow");
   text("WaistPain",windowWidth/4+70,windowHeight/2);
   eyepain.visible = true;
   textSize(30);
   fill("yellow");
   text("EyePain",windowWidth/4+380,windowHeight/2+10);
   legpain.visible = true;
   textSize(30);
   fill("yellow");
   text("LegPain",windowWidth/4+670,windowHeight/2);
